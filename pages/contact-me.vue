                                ...
                                <div class="contact-us-info">
                                    ...
                                    <ul class="address-list">
                                        <li>
                                            ...
                                            <p>Rue des Addafla, Casablanca 20250</p>
                                        </li>
                                        <li>
                                            <h5 class="title">Email</h5>
                                            <p><a href="mailto:info@mindmetric.com" target="_blank">info@mindmetric.com</a>
                                            </p>
                                        </li>
                                        <li>
                                            <h5 class="title">Phone</h5>
                                            <p><a href="tel:+0914135548598">(+212) 708 279 407</a></p>
                                        </li>
                                    </ul>

                                    <ul class="social-share">
                                        <li><a href="https://www.linkedin.com/in/zsoulaimane"><i
