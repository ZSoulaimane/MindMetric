...
import nuxt_plugin_plugin_696ac0f1 from 'nuxt_plugin_plugin_696ac0f1' // Source: ./components/plugin.js (mode: 'all')
import nuxt_plugin_pluginserver_f424d556 from 'nuxt_plugin_pluginserver_f424d556' // Source: ./color-mode/plugin.server.js (mode: 'server')
import nuxt_plugin_pluginclient_203423cd from 'nuxt_plugin_pluginclient_203423cd' // Source: ./color-mode/plugin.client.js (mode: 'client')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"mindmetric","titleTemplate":"%s - MindMetric","htmlAttrs":{"lang":"ENG"},"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.png"}],"script":[{"src":"\u002Fjs\u002Fpace.min.js"}],"style":[]},
  ...
  if (typeof nuxt_plugin_plugin_696ac0f1 === 'function') {
    await nuxt_plugin_plugin_696ac0f1(app.context, inject)
  }

  if (process.server && typeof nuxt_plugin_pluginserver_f424d556 === 'function') {
    await nuxt_plugin_pluginserver_f424d556(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_pluginclient_203423cd === 'function') {
    await nuxt_plugin_pluginclient_203423cd(app.context, inject)
  }
